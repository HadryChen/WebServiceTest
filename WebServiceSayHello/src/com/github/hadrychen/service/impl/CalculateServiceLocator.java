...
public class CalculateServiceLocator extends org.apache.axis.client.Service implements com.github.hadrychen.service.impl.CalculateService {
    ...
    private java.lang.String CalculatePort_address = "http://localhost:8080/Service/MyWebService";
    ...
    public com.github.hadrychen.service.impl.Calculate getCalculatePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.github.hadrychen.service.impl.CalculatePortBindingStub _stub = new com.github.hadrychen.service.impl.CalculatePortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.github.hadrychen.service.impl.Calculate.class.isAssignableFrom(serviceEndpointInterface)) {
                com.github.hadrychen.service.impl.CalculatePortBindingStub _stub = new com.github.hadrychen.service.impl.CalculatePortBindingStub(new java.net.URL(CalculatePort_address), this);
                _stub.setPortName(getCalculatePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://impl.service.hadrychen.github.com/", "CalculateService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://impl.service.hadrychen.github.com/", "CalculatePort"));
        }
